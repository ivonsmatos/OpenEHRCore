...
TypeScript SDK for HealthStack FHIR API.

## Installation

```bash
npm install @healthstack/sdk
```

## Quick Start

```typescript
import { OpenEHRClient } from "@healthstack/sdk";
...
```typescript
import { AuthClient } from "@healthstack/sdk";
...
```typescript
import { FHIRClient } from "@healthstack/sdk";
