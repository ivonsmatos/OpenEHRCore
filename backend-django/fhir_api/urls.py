...
from . import (
    ...
    views_procedure,
    views_medication,
    views_healthcare_service,
    views_diagnostic_report,
    views_consent_fhir,
    views_audit_event,
    views_terminology,
    views_bulk_data,
    ...
    views_agent,
    views_validation,
    views_crm_validation,
)
from .metrics import metrics_view

# Import transcription ViewSet
from transcription.views import TranscriptionViewSet
...
router.register(
    r"careplan-activities", CarePlanActivityViewSet, basename="careplan-activity"
)
...
urlpatterns = [
    ...
    path("financial/metrics/", views_financial_metrics.financial_metrics, name="financial_metrics"),
    ...
    path(
        "patients/search/",
        views_auth.search_patients_advanced,
    ...
    path(
        "encounters/search/", views_search.search_encounters, name="search_encounters"
    ),  # Sprint 20
    path(
        "patients/<str:patient_id>/encounters/",
        views_auth.get_encounters,
        name="get_encounters",
    ),
    ...
    path(
        "observations/search/",
        views_search.search_observations,
        name="search_observations",
    ),  # Sprint 20
    path(
        "patients/<str:patient_id>/observations/",
        views_auth.get_observations,
        name="get_observations",
    ),
    # Condition endpoints
    path("conditions/", views_auth.create_condition, name="create_condition"),
    path(
        "conditions/search/", views_search.search_conditions, name="search_conditions"
    ),  # Sprint 20
    path(
        "patients/<str:patient_id>/conditions/",
        views_auth.get_conditions,
        name="get_conditions",
    ),
    # Allergy endpoints
    ...
    path(
        ...
        views_auth.get_appointments,
        name="get_appointments",
    ),
    # Medication endpoints
    path(
        "medications/",
        views_auth.create_medication_request,
    ...
    path(
        ...
        views_auth.create_clinical_impression,
    ...
    path(
        "questionnaires/",
        views_auth.create_questionnaire_view,
        name="create_questionnaire",
    ),
    path(
        "questionnaires/response/",
        views_auth.create_response_view,
    ...
    path(
        ...
        views_auth.get_my_appointments,
    ...
    path(
        "documents/",
        views_documents.documents_list_create,
        name="documents_list_create",
    ),
    path(
        "documents/<str:composition_id>/",
        views_documents.delete_document,
        name="delete_document",
    ),
    path(
        "documents/<str:composition_id>/pdf/",
        views_documents.generate_pdf,
        name="generate_pdf",
    ),
    # Sprint 9: Analytics
    ...
    path(
        "immunizations/", views_clinical.create_immunization, name="create_immunization"
    ),
    path(
        "patients/<str:patient_id>/immunizations/",
        views_clinical.get_immunizations,
        name="get_immunizations",
    ),
    path(
        "diagnostic-reports/",
        views_clinical.create_diagnostic_report,
        name="create_diagnostic_report",
    ),
    path(
        "patients/<str:patient_id>/diagnostic-reports/",
        views_clinical.get_diagnostic_reports,
        name="get_diagnostic_reports",
    ),
    # Sprint 11: Export Data & Audit
    path(
        "patients/<str:patient_id>/export/",
        views_export.export_patient_data_view,
    ...
    path(
        "analytics/survey/", views_analytics.get_survey_metrics, name="analytics-survey"
    ),
    path(
        "analytics/admissions/",
        views_analytics.get_admissions_metrics,
        name="analytics-admissions",
    ),
    path(
        "analytics/report/",
        views_analytics.generate_analytics_report,
    ...
    path(
        "chat/attachment/<str:message_id>/",
        views_chat.download_attachment,
    ...
    path(
        "ipd/bed/<str:location_id>/details/",
        views_ipd.get_bed_details,
        name="get_bed_details",
    ),
    path("ipd/discharge/", views_ipd.discharge_patient, name="discharge_patient"),
    path(
        "ipd/bed/<str:location_id>/clean/",
        views_ipd.finish_cleaning,
    ...
    path(
        "ipd/bed/<str:location_id>/history/",
        views_ipd.get_bed_history,
        name="get_bed_history",
    ),
    # Sprint 18: Practitioner Management (FHIR Compliance)
    path(
        "practitioners/",
        views_practitioners.create_practitioner,
        name="create_practitioner",
    ),
    path(
        "practitioners/list/",
        views_practitioners.list_practitioners,
        name="list_practitioners",
    ),
    path(
        "practitioners/search/",
        views_search.search_practitioners,
        name="search_practitioners",
    ),  # Sprint 20
    path(
        "practitioners/specialties/",
        views_practitioners.list_specialties,
        name="list_specialties",
    ),  # Sprint 21
    path(
        "practitioners/validate-identifier/",
        views_practitioners.validate_identifier,
        name="validate_identifier",
    ),  # Sprint 21
    path(
        "practitioners/<str:practitioner_id>/",
        views_practitioners.get_or_update_practitioner,
        name="get_or_update_practitioner",
    ),  # GET + PUT
    path(
        "practitioner-roles/",
        views_practitioners.create_practitioner_role,
        name="create_practitioner_role",
    ),
    ...
    path(
        "organizations/",
        views_organization.manage_organizations,
        name="manage_organizations",
    ),
    path(
        "organizations/<str:organization_id>/",
        views_organization.organization_detail,
        name="organization_detail",
    ),
    path(
        "organizations/<str:organization_id>/hierarchy/",
        views_organization.organization_hierarchy,
    ...
    path(
        "procedures/<str:procedure_id>/",
        views_procedure.procedure_detail,
        name="procedure_detail",
    ),
    path(
        "patients/<str:patient_id>/procedures/",
        views_procedure.patient_procedures,
        name="patient_procedures",
    ),
    # Sprint 21: MedicationRequest Aprimorado (Prescrições)
    path(
        "medication-requests/",
        views_medication.manage_medication_requests,
        name="manage_medication_requests",
    ),
    path(
        "medication-requests/<str:medication_request_id>/",
        views_medication.medication_request_detail,
        name="medication_request_detail",
    ),
    path(
        "patients/<str:patient_id>/medications/",
        views_medication.patient_medications,
        name="patient_medications",
    ),
    # Sprint 21: HealthcareService (Serviços de Saúde)
    path(
        "healthcare-services/",
        views_healthcare_service.manage_healthcare_services,
        name="manage_healthcare_services",
    ),
    path(
        "healthcare-services/<str:service_id>/",
        views_healthcare_service.healthcare_service_detail,
        name="healthcare_service_detail",
    ),
    path(
        "organizations/<str:organization_id>/services/",
        views_healthcare_service.organization_services,
        name="organization_services",
    ),
    # Sprint 21: DiagnosticReport CRUD Completo (Laudos/Exames)
    path(
        "diagnostic-reports-v2/",
        views_diagnostic_report.manage_diagnostic_reports,
        name="manage_diagnostic_reports_v2",
    ),
    path(
        "diagnostic-reports-v2/<str:report_id>/",
        views_diagnostic_report.diagnostic_report_detail,
        name="diagnostic_report_detail_v2",
    ),
    # Sprint 22: Consent FHIR (LGPD Compliance)
    path("consents-v2/", views_consent_fhir.manage_consents, name="manage_consents_v2"),
    path(
        "consents-v2/<str:consent_id>/",
        views_consent_fhir.consent_detail,
        name="consent_detail_v2",
    ),
    path(
        "patients/<str:patient_id>/consents/",
        views_consent_fhir.patient_consents,
        name="patient_consents",
    ),
    path(
        "patients/<str:patient_id>/consents/revoke-all/",
        views_consent_fhir.revoke_all_consents,
        name="revoke_all_consents",
    ),
    # Sprint 22: AuditEvent (Security Logging)
    path(
        "audit-events/", views_audit_event.list_audit_events, name="list_audit_events"
    ),
    path(
        "audit-events/<str:event_id>/",
        views_audit_event.audit_event_detail,
        name="audit_event_detail",
    ),
    path(
        "audit-events/security-report/",
        views_audit_event.security_report,
        name="security_report",
    ),
    path(
        "patients/<str:patient_id>/audit-trail/",
        views_audit_event.patient_audit_trail,
        name="patient_audit_trail",
    ),
    # Sprint 21: Terminology Services (RxNorm, ICD-10, TUSS)
    # RxNorm (Medications)
    path(
        "terminology/rxnorm/search/",
        views_terminology.search_rxnorm,
        name="search_rxnorm",
    ),
    path(
        "terminology/rxnorm/<str:rxcui>/",
        views_terminology.get_rxnorm_details,
        name="get_rxnorm_details",
    ),
    path(
        "terminology/rxnorm/<str:rxcui>/interactions/",
        views_terminology.get_rxnorm_interactions,
        name="get_rxnorm_interactions",
    ),
    path(
        "terminology/rxnorm/interactions/check/",
        views_terminology.check_multi_interactions,
        name="check_multi_interactions",
    ),
    # ICD-10 (Diagnoses)
    path(
        "terminology/icd10/search/", views_terminology.search_icd10, name="search_icd10"
    ),
    path(
        "terminology/icd10/<str:code>/",
        views_terminology.validate_icd10,
        name="validate_icd10",
    ),
    # TUSS (Brazilian Procedures)
    path("terminology/tuss/search/", views_terminology.search_tuss, name="search_tuss"),
    path(
        "terminology/tuss/<str:code>/",
        views_terminology.validate_tuss,
        name="validate_tuss",
    ),
    path(
        "terminology/tuss/type/<str:procedure_type>/",
        views_terminology.list_tuss_by_type,
        name="list_tuss_by_type",
    ),
    # Terminology Mapping (ICD-10 <-> SNOMED CT)
    path(
        "terminology/map/icd10-to-snomed/<str:icd10_code>/",
        views_terminology.map_icd10_to_snomed,
        name="map_icd10_to_snomed",
    ),
    path(
        "terminology/map/snomed-to-icd10/<str:snomed_code>/",
        views_terminology.map_snomed_to_icd10,
    ...
    path(
        ...
        views_terminology.valueset_expand,
        name="valueset_expand",
    ),
    path(
        "terminology/ValueSet/$validate-code",
        views_terminology.valueset_validate_code,
        name="valueset_validate_code",
    ),
    path(
        "terminology/CodeSystem/$lookup",
        views_terminology.codesystem_lookup,
        name="codesystem_lookup",
    ),
    path(
        "terminology/ConceptMap/$translate",
        views_terminology.conceptmap_translate,
        name="conceptmap_translate",
    ),
    # Sprint 22: FHIR Bulk Data Export ($export)
    path("export/Patient/", views_bulk_data.export_patient, name="export_patient"),
    path(
        "export/Group/<str:group_id>/",
        views_bulk_data.export_group,
        name="export_group",
    ),
    path("export/System/", views_bulk_data.export_system, name="export_system"),
    path(
        "export/status/<str:job_id>/",
        views_bulk_data.export_status,
        name="export_status",
    ),
    path("export/jobs/", views_bulk_data.list_exports, name="list_exports"),
    path(
        "export/files/<str:job_id>/<str:file_name>/",
        views_bulk_data.download_export_file,
        name="download_export_file",
    ),
    # Sprint 22: FHIR Bulk Data Import ($import)
    path("import/", views_bulk_data.import_bulk, name="import_bulk"),
    path(
        "import/status/<str:job_id>/",
        views_bulk_data.import_status,
        name="import_status",
    ),
    # Sprint 22: SMART on FHIR OAuth2 Scopes
    path("smart/scopes/", views_bulk_data.list_smart_scopes, name="list_smart_scopes"),
    path(
        "smart/scopes/validate/",
        views_bulk_data.validate_smart_scopes,
        name="validate_smart_scopes",
    ),
    path(
        "smart/access/check/",
        views_bulk_data.check_smart_access,
        name="check_smart_access",
    ),
    # Sprint 24: LGPD Privacy Controls
    path(
        "patients/<str:patient_id>/access-logs/",
        views_lgpd.patient_access_logs,
        name="patient_access_logs",
    ),
    path(
        "patients/<str:patient_id>/data-export/",
        views_lgpd.request_data_export,
        name="request_data_export",
    ),
    path(
        "patients/<str:patient_id>/data-export/preview/",
        views_lgpd.preview_data_export,
        name="preview_data_export",
    ),
    path(
        "patients/<str:patient_id>/data-deletion/",
        views_lgpd.request_data_deletion,
        name="request_data_deletion",
    ),
    path(
        "patients/<str:patient_id>/check-consent/",
        views_lgpd.check_patient_consent,
        name="check_patient_consent",
    ),
    path(
        "patients/<str:patient_id>/lgpd-report/",
        views_lgpd.patient_lgpd_report,
        name="patient_lgpd_report",
    ),
    ...
    path(
        "lgpd/requests/<str:request_id>/",
        views_lgpd.lgpd_request_detail,
        name="lgpd_request_detail",
    ),
    ...
    path(
        "compositions/",
        views_composition.manage_compositions,
        name="manage_compositions",
    ),
    path(
        "compositions/types/",
        views_composition.composition_types,
        name="composition_types",
    ),
    path(
        "compositions/<str:composition_id>/",
        views_composition.composition_detail,
        name="composition_detail",
    ),
    path(
        "patients/<str:patient_id>/compositions/",
        views_composition.patient_compositions,
        name="patient_compositions",
    ),
    # ================================================================
    ...
    path(
        "lab/convert-hl7/",
        views_integrations.converter_hl7_para_fhir,
        name="lab_convert_hl7",
    ),
    path(
        "lab/diagnostic-report/",
        views_integrations.criar_diagnostic_report,
        name="lab_diagnostic_report",
    ),
    # PACS / Imagens
    ...
    path(
        "pacs/studies/<str:study_uid>/series/",
        views_integrations.obter_series_estudo,
        name="pacs_series",
    ),
    path(
        "pacs/studies/<str:study_uid>/viewer/",
        views_integrations.obter_viewer_url,
        name="pacs_viewer",
    ),
    path(
        "patients/<str:patient_id>/imaging/",
        views_integrations.estudos_paciente_pacs,
        name="patient_imaging",
    ),
    # Farmácia
    path(
        "pharmacy/process/",
        views_integrations.processar_prescricao_farmacia,
        name="pharmacy_process",
    ),
    path(
        "pharmacy/dispense/",
        views_integrations.criar_dispensacao,
        name="pharmacy_dispense",
    ),
    path(
        "pharmacy/dispense/<str:dispense_id>/deliver/",
        views_integrations.confirmar_entrega_medicamento,
        name="pharmacy_deliver",
    ),
    path(
        "pharmacy/dispense/<str:dispense_id>/return/",
        views_integrations.registrar_devolucao,
        name="pharmacy_return",
    ),
    path(
        "pharmacy/interactions/",
        views_integrations.verificar_interacoes,
        name="pharmacy_interactions",
    ),
    path(
        "pharmacy/report/",
        views_integrations.relatorio_consumo_farmacia,
    ...
    path(
        "referrals/pending/", views_referral.pending_referrals, name="pending_referrals"
    ),
    path(
        "referrals/<str:referral_id>/",
        views_referral.referral_detail,
        name="referral_detail",
    ),
    path(
        "referrals/<str:referral_id>/accept/",
        views_referral.accept_referral,
        name="accept_referral",
    ),
    path(
        "referrals/<str:referral_id>/complete/",
        views_referral.complete_referral,
        name="complete_referral",
    ),
    path(
        "patients/<str:patient_id>/referrals/",
        views_referral.patient_referrals,
        name="patient_referrals",
    ),
    # Comunicação entre profissionais
    path(
        "communications/",
        views_communication.manage_communications,
        name="communications",
    ),
    path(
        "communications/request-opinion/",
        views_communication.request_opinion,
        name="request_opinion",
    ),
    path(
        "communications/<str:communication_id>/",
        views_communication.communication_detail,
        name="communication_detail",
    ),
    path(
        "communications/<str:communication_id>/reply/",
        views_communication.reply_communication,
        name="reply_communication",
    ),
    path(
        "practitioners/<str:practitioner_id>/inbox/",
        views_communication.inbox,
        name="practitioner_inbox",
    ),
    path(
        "practitioners/<str:practitioner_id>/sent/",
        views_communication.sent_messages,
        name="practitioner_sent",
    ),
    path(
        "patients/<str:patient_id>/communications/",
        views_communication.patient_communications,
        name="patient_communications",
    ),
    # Notificações Compulsórias (SINAN)
    path(
        "notifications/", views_notifications.manage_notifications, name="notifications"
    ),
    path(
        "notifications/conditions/",
        views_notifications.list_notifiable_conditions,
        name="notifiable_conditions",
    ),
    path(
        "notifications/pending/",
        views_notifications.pending_notifications,
        name="pending_notifications",
    ),
    path(
        "notifications/stats/",
        views_notifications.notification_stats,
        name="notification_stats",
    ),
    path(
        "notifications/check/",
        views_notifications.check_notifiable,
        name="check_notifiable",
    ),
    path(
        "notifications/<str:notification_id>/send/",
        views_notifications.send_to_sinan,
        name="send_to_sinan",
    ),
    # ================================================================
    ...
    path(
        "cbo/practitioner-qualification/",
        views_cbo.gerar_qualification_practitioner,
        name="cbo_qualification",
    ),
    ...
    path(
        "cbo/nursing-technicians/",
        views_cbo.listar_tecnicos_enfermagem_cbo,
        name="cbo_nursing_technicians",
    ),
    ...
    path(
        ...
        views_automation.subscription_detail,
    ...
    path(
        "bots/<str:bot_id>/execute/", views_automation.execute_bot, name="execute_bot"
    ),
    path(
        "bots/<str:bot_id>/history/", views_automation.bot_history, name="bot_history"
    ),
    # Webhooks (External triggers)
    path(
        "webhooks/<str:webhook_id>/",
        views_automation.webhook_receiver,
        name="webhook_receiver",
    ),
    # Billing - Coverage (Insurance)
    path("billing/coverage/", views_billing.manage_coverage, name="billing_coverage"),
    path(
        "billing/coverage/<str:coverage_id>/",
        views_billing.coverage_detail,
        name="billing_coverage_detail",
    ),
    # Billing - Claims
    path("billing/claims/", views_billing.manage_claims, name="billing_claims"),
    path(
        "billing/claims/<str:claim_id>/",
        views_billing.claim_detail,
        name="billing_claim_detail",
    ),
    path(
        "billing/claims/<str:claim_id>/submit/",
        views_billing.submit_claim,
        name="billing_submit_claim",
    ),
    # Billing - Dashboard
    path(
        "billing/dashboard/", views_billing.billing_dashboard, name="billing_dashboard"
    ),
    # ============================================================================
    ...
    path(
        "prescriptions/drugs/",
        views_prescription.search_drugs,
        name="prescription_search_drugs",
    ),
    path(
        "prescriptions/drugs/<str:drug_code>/",
        views_prescription.get_drug_details,
        name="prescription_drug_details",
    ),
    path(
        "prescriptions/drugs/<str:drug_code>/validate/",
        views_prescription.validate_controlled_drug,
        name="prescription_validate_drug",
    ),
    # Prescriptions
    path(
        "prescriptions/",
        views_prescription.create_prescription,
        name="prescription_create",
    ),
    path(
        "prescriptions/<str:prescription_id>/sign/",
        views_prescription.sign_prescription,
        name="prescription_sign",
    ),
    # Patient Prescriptions
    path(
        "patients/<str:patient_id>/prescriptions/",
        views_prescription.patient_prescriptions,
    ...
    path(
        ...
        views_smart.smart_configuration,
        name="smart_config",
    ),
    ...
    path(
        ...
        views_fhircast.fhircast_well_known,
        name="fhircast_config",
    ),
    path("fhircast/events", views_fhircast.event_types, name="fhircast_event_types"),
    # Sessions
    path(
        "fhircast/session",
        views_fhircast.create_session,
        name="fhircast_create_session",
    ),
    # Subscriptions
    path("fhircast/subscribe", views_fhircast.subscribe, name="fhircast_subscribe"),
    path(
        "fhircast/unsubscribe", views_fhircast.unsubscribe, name="fhircast_unsubscribe"
    ),
    # Topic Operations
    path(
        "fhircast/<str:topic>", views_fhircast.get_context, name="fhircast_get_context"
    ),
    path(
        "fhircast/<str:topic>/publish",
        views_fhircast.publish_event,
        name="fhircast_publish",
    ),
    path(
        "fhircast/<str:topic>/history",
        views_fhircast.get_history,
        name="fhircast_history",
    ),
    path(
        "fhircast/<str:topic>/subscribers",
        views_fhircast.get_subscribers,
        name="fhircast_subscribers",
    ),
    # ============================================================================
    ...
    path(
        "compliance/status",
        views_compliance.compliance_status,
        name="compliance_status",
    ),
    # Bias Prevention
    path(
        "compliance/bias/validate",
        views_compliance.validate_content,
        name="bias_validate",
    ),
    path(
        "compliance/bias/validate-recommendation",
        views_compliance.validate_recommendation,
        name="bias_validate_recommendation",
    ),
    path(
        "compliance/bias/report", views_compliance.bias_audit_report, name="bias_report"
    ),
    # Anonymization
    path(
        "compliance/anonymize", views_compliance.anonymize_data, name="anonymize_data"
    ),
    # ISO 13606-2 Archetypes
    path("archetypes/", views_compliance.list_archetypes, name="list_archetypes"),
    path(
        "archetypes/<str:archetype_name>/",
        views_compliance.get_archetype,
        name="get_archetype",
    ),
    path(
        "archetypes/<str:archetype_name>/validate/",
        views_compliance.validate_archetype_data,
        name="validate_archetype",
    ),
    path(
        "archetypes/<str:archetype_name>/to-fhir/",
        views_compliance.map_to_fhir,
        name="archetype_to_fhir",
    ),
    # Terminology Codes
    path(
        "terminology/codes/",
        views_compliance.get_terminology_codes,
    ...
    path(
        "questionnaires/",
        views_questionnaire.list_questionnaires,
        name="list_questionnaires",
    ),
    path(
        "questionnaires/<str:questionnaire_id>/",
        views_questionnaire.get_questionnaire,
        name="get_questionnaire",
    ),
    path(
        "questionnaires/create/",
        views_questionnaire.create_questionnaire,
        name="create_questionnaire",
    ),
    path(
        "questionnaires/<str:questionnaire_id>/responses/",
        views_questionnaire.submit_response,
        name="submit_response",
    ),
    path(
        "questionnaire-responses/",
        views_questionnaire.get_responses,
        name="get_responses",
    ),
    path(
        "questionnaire-responses/<str:response_id>/",
        views_questionnaire.get_response,
        name="get_response_detail",
    ),
    path(
        "patients/<str:patient_id>/assessments/",
        views_questionnaire.patient_assessments,
    ...
    path(
        "pix/payments/create/",
        views_brazil.create_pix_payment,
        name="create_pix_payment",
    ),
    path(
        "pix/payments/<str:payment_id>/",
        views_brazil.get_pix_payment,
    ...
    path(
        ...
        views_brazil.send_appointment_reminder,
        name="send_appointment_reminder",
    ),
    path(
        "whatsapp/messages/",
        views_brazil.list_whatsapp_messages,
    ...
    path(
        ...
        views_brazil.list_telemedicine_sessions,
        name="list_telemedicine_sessions",
    ),
    path(
        "telemedicine/sessions/create/",
        views_brazil.create_telemedicine_session,
        name="create_telemedicine_session",
    ),
    path(
        "telemedicine/sessions/<str:session_id>/",
        views_brazil.get_telemedicine_session,
        name="get_telemedicine_session",
    ),
    path(
        "telemedicine/sessions/<str:session_id>/start",
        views_brazil.start_telemedicine_session,
        name="start_telemedicine_session",
    ),
    path(
        "telemedicine/sessions/<str:session_id>/end",
        views_brazil.end_telemedicine_session,
        name="end_telemedicine_session",
    ),
    path(
        "telemedicine/sessions/<str:session_id>/cancel",
        views_brazil.cancel_telemedicine_session,
        name="cancel_telemedicine_session",
    ),
    path(
        "telemedicine/practitioners/<str:practitioner_id>/upcoming",
        views_brazil.upcoming_sessions,
        name="upcoming_telemedicine_sessions",
    ),
    # ============================================================================
    ...
    path(
        "agent/hl7/receive",
        views_agent.receive_hl7_from_agent,
        name="agent_receive_hl7",
    ),
    ...
    # ============================================================================
    path(
        "fhir/validation-info",
        views_validation.validation_info,
        name="fhir_validation_info",
    ),
    path("fhir/validate", views_validation.validate_resource, name="fhir_validate"),
    path(
        "fhir/validate-bundle",
        views_validation.validate_bundle,
        name="fhir_validate_bundle",
    ),
    path(
        "fhir/quick-validate",
        views_validation.quick_validate,
        name="fhir_quick_validate",
    ),
    path(
        "fhir/check-reference",
        views_validation.check_reference,
        name="fhir_check_reference",
    ),
    path(
        "fhir/profiles/<str:resource_type>",
        views_validation.list_profiles,
        name="fhir_list_profiles",
    ),
    # ============================================================================
    ...
    path(
        "crm/info/",
        views_crm_validation.crm_validation_info,
        name="crm_validation_info",
    ),
    path("crm/validate/", views_crm_validation.validate_crm, name="crm_validate"),
    path(
        "crm/validate-batch/",
        views_crm_validation.validate_crm_batch,
        name="crm_validate_batch",
    ),
    path(
        "crm/conselhos/", views_crm_validation.list_conselhos, name="crm_list_conselhos"
    ),
    path(
        "crm/stats/",
        views_crm_validation.crm_validation_stats,
        name="crm_validation_stats",
    ),
    path(
        "crm/invalidate-cache/",
        views_crm_validation.invalidate_crm_cache,
        name="crm_invalidate_cache",
    ),
]
