...
def list_questionnaires(request):
    ...
    return Response({"count": len(questionnaires), "questionnaires": questionnaires})
...
def get_responses(request):
    ...
    return Response({"count": len(responses), "responses": responses})
...
def patient_assessments(request, patient_id):
    ...
    return Response(
        {"patient_id": patient_id, "assessments": list(assessments.values())}
    )
